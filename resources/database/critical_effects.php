  	...
  	if ($damageType == "Energy"){
  		...
  		if($testlocation == 1){
  			...
  			if($critTotal == 3){
  				...
  				echo nl2br("The attack cooks off the target’s ear, leaving him with a partially burned stump of cartilage. He is Deafened for  1d5 hours (or until he receives medical attention).");
  			}
  			if($critTotal == 4){

  				echo nl2br("The energy attack burns away all of the hairs on the target’s head, as well as leaving him reeling from the injury. The target suffers 2 levels of Fatigue and the target is Blinded for 1d5 rounds.");
  			}
  			if($critTotal == 5){

  				echo nl2br("A blast of energy envelops the target’s head, burning his face and hair, crisping his skin, and causing him to scream like a stuck grox. In addition to losing all hair on his scalp and face, he is Blinded for 1d10 rounds rounds and Stunned for 1 round. Permanently reduce the target’s Fellowship characteristic by 1.");
  			}
  			if($critTotal == 6){
  				echo nl2br("The attack cooks the target’s face, melting his features and damaging his eyes. The target suffers 1d5 levels of Fatigue and isBlinded for 1d10 hours. Permanently reduce his Fellowship and Perception characteristics by 1d5.");
  			}
  			if($critTotal == 7){
  				$Fatigue = random_int(1,10);
  				$Fellowship = random_int(1,10);
  				echo nl2br("In a gruesome display, the flesh is burned from the target’s head, exposing charred bone and muscle underneath. The target suffers 1d10 levels of Fatigue. He is Blinded permanently. Roll 1d10; this is the target’s new Fellowship characteristic value. If his Fellowship value is already 10 or lower, this can be skipped as no one would notice any difference in his behaviour and demeanour. ");
  			}
  			if($critTotal == 8){
